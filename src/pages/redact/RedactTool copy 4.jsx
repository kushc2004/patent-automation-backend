...
// Updated renderStrikethroughs to handle coordinate conversion and scaling with debugging
const renderStrikethroughs = (rectangles, pageNumber, pageWidth, pageHeight, scale) => {
    console.log("Rendering strikethroughs for page:", pageNumber);
    console.log("Rectangles data:", rectangles);

    return rectangles
        .filter(rect => rect.page === pageNumber) // Ensure rectangles are for the current page
        .map((rect, index) => {
            console.log(`Rendering rectangle ${index} on page ${pageNumber}:`, rect);
            ...
            console.log(`Calculated Position - Left: ${left}, Top: ${top}, Width: ${width}, Height: ${height}`);
                ...
                <Worker workerUrl={`https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js`}>
                    <Viewer
                        ...
                        renderPageLayer={(props) => {
                            // Debugging: Log when a page layer is being rendered
                            console.log(`Rendering page layer for page ${props.page.index}`);
                            return (
...
const RedactTool = () => {
    ...
    const handleRedact = async () => {
        ...
        try {
            ...
            console.log("Redaction API Response:", data);
    ...
    const handleDownloadPDF = async () => {
        ...
        const file = files[0];
        console.log("File path for download:", file.path);
    ...
    const openEditModal = async (file) => {
        ...
        console.log(`Opening edit modal for file: ${filePath}`);

        const fetchedFile = await fetchFile(filePath);

        if (fetchedFile) {
            console.log("Fetched file for editing:", fetchedFile);
                ...
                <div className="flex flex-col items-center p-6 flex-1">
                    ...
                    <div className="bg-white shadow-md rounded-lg w-full max-w-4xl p-6">
                        ...
                        <Modal
                            ...
                            className="w-4/5 h-4/5 bg-white rounded-lg shadow-xl p-6 mx-auto mt-12 flex flex-col"
                            overlayClassName="fixed inset-0 bg-black bg-opacity-50 z-50"
                        >
                            {/* PDF Preview */}
                            <div className="flex-1 w-full border-r-2 overflow-y-scroll p-4">
