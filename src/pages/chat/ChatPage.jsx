    ...
    return (
        <div className="flex flex-col h-screen w-screen">
            ...
            <div className="flex h-full">
                {!isDocumentCollapsed && (
                    <div className={`transition-all duration-300 ${isCaseOverlayOpen ? 'w-1/2' : 'w-1/4'} bg-[#EFF3F6] p-4 rounded-2xl my-4 mx-2 overflow-y-auto`}>
                        <button onClick={() => setIsDocumentCollapsed(true)} className="text-gray-500 hover:text-gray-700 mb-4">
                            <span>⬅️ Collapse</span>
                        </button>
                        {!isCaseOverlayOpen ? (
                            <div>
                                <div className="flex items-center justify-center text-white p-4">
                                    ...
                                    <h1 className="text-xl font-bold text-[#26262A]">Legal AI</h1>
                                </div>
